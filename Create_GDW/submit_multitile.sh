...
#run python script to extract Water Observation statistics by tiles, for those waterbodies that cover more than one tile
python extractWOFS_by_multitile.py
